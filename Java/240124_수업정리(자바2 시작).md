...
![](../image/Pasted%20image%2020240124120740.png)
...
![](../image/Pasted%20image%2020240124140248.png)
pivtate 사용하면 정의한 클래스 외부에서 new로 객체 생성할 수 없음


# polygon 예제 (protected 제어자)
![](../image/Pasted%20image%2020240124142254.png)
...
![](../image/Pasted%20image%2020240124160851.png)
...
# 기초적인 자바 클래스들
![](../image/Pasted%20image%2020240124162854.png)

![](../image/Pasted%20image%2020240124163136.png)
빈번한 조작에는 적합하지 않다. (연산할 때마다 계속 메모리 공간을 할당하기 때문에)
문자열 리터럴은 주소값이 같다
객체로 생성된 똑같은 문자열을 가르키고 있는 주소는 서로 다름

![](../image/Pasted%20image%2020240124163425.png)
