...
📌Jenkins가 빌드하는 과정에서, docker-compose up -d 명령을 수행하게 되고, 배포용 서버(web-server 인스턴스)에서 docker container ps -a 명령을 하면, contaner가 작동하고 있는 것을 확인할 수 있다! => 그러면 publicIP:9000 입력하면,, 사이트에 접속할 수 